      ...
      <section className="w-full max-w-[1440px] mx-auto px-margin-mobile md:px-margin-desktop py-section-gap" id="explore">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-gutter">
          ...
          <div className="md:col-span-8 group relative overflow-hidden cursor-pointer">
            ...
            <img alt="The Atelier Series" className="w-full h-[600px] object-cover transform transition-transform duration-700 group-hover:scale-102" src="https://lh3.googleusercontent.com/aida-public/AB6AXuDb7sWeUzbKVtgszGEoSXD2i1BRQulC9SCz7s3sFItXSt3dIxfX0gMHJKdfSwofJlBK1MYc9I7I-J0HaJCu2D3xmprzXTMWtTVTmru8CS328YaX01uiRbcMi_kM6MmPeTXDBO6_uc8mJoqQwRJgFvUbruTCMyjbD_-6XpmGjyk3RZ9OepvOeV-j1_8NLFFrBeOQjQ9SqCFn68tmdzLXunyXcrJ9B302apZz5arJXGnvgIiRxaN040tru_79KBz4Z2KHem-YTWEBx7M"/>
            <div className="absolute bottom-0 left-0 p-8 z-20 w-full bg-gradient-to-t from-black/60 to-transparent">
              ...
              <Link className="font-label-lg text-label-lg text-white uppercase tracking-widest border-b border-white pb-1 inline-block hover:text-tertiary hover:border-tertiary transition-colors" to="/atelier">Discover</Link>
            </div>
          </div>
          {/* Stacked Medium Cards */}
          <div className="md:col-span-4 flex flex-col gap-gutter">
            <Link className="flex-1 group relative overflow-hidden cursor-pointer bg-surface-container" to="/categories">
              <div className="absolute inset-0 image-overlay z-10 transition-opacity duration-300 group-hover:opacity-0 pointer-events-none"></div>
              <img alt="Bespoke Gold" className="w-full h-full object-cover transform transition-transform duration-700 group-hover:scale-102" src="https://lh3.googleusercontent.com/aida-public/AB6AXuCZbcIbhZ4b4Dc-CX1Pp6aa7sWTM8FQ851fyI0nFydWEE4G9tz-kPhjbpwI47QoHwkoZuFDpJv_icYf6xVphn2P0PWimcYqzcwitH0enHB6XskuK8Z11Gr3FyotTGYyXWrTqpaY8Lm5oh2FxEancX0GRKsQFm6e7q9nM_HHs_y_2bE0-vOXdRpDDl7FRzAMzp7FJTg61wU-wYe4r3xZcImIM091cvM48tcX_USRWaRNCnzoCS4jzSvpO-wRFKPct8VTlnuLtZRYbXk"/>
            ...
            <Link className="flex-1 group relative overflow-hidden cursor-pointer bg-surface-container" to="/new-arrivals">
              <div className="absolute inset-0 image-overlay z-10 transition-opacity duration-300 group-hover:opacity-0 pointer-events-none"></div>
              <img alt="Diamond Essentials" className="w-full h-full object-cover transform transition-transform duration-700 group-hover:scale-102" src="https://lh3.googleusercontent.com/aida-public/AB6AXuAEmjYObD4DizgcS1v08Xz-3xW1kDZGQVlwdkSgwkPR3KaDBxL9b_2UoYjDWpElPCokbvVh_ACyVNX0FkwHp8u9TpIp25F66Fua-pH4fqHeUh1h_XPJaYxZkLyfK6wiQtyvdVoeZ2kNeMjizLz_DmG8zTpuSjNxl0nUU6_pnw2UGqKN1h9bZ8yWi0ejaN_GD8AxiwxcuAcq7_W-qRp4NqtTedbp2lryskBgUaAM8G3YddVv82zw6S4KpViw9mefvsX8godkm9t4xpg"/>
              <div className="absolute bottom-0 left-0 p-6 z-20 w-full bg-gradient-to-t from-black/50 to-transparent">
      ...
      <section className="w-full bg-surface-container-high py-section-gap my-section-gap">
        <div className="max-w-[1440px] mx-auto px-margin-mobile md:px-margin-desktop flex flex-col md:flex-row items-center gap-16">
          <div className="w-full md:w-5/12 order-2 md:order-1">
            ...
            <Link className="font-label-lg text-label-lg text-tertiary uppercase border-b border-tertiary pb-1 hover:text-on-background hover:border-on-background transition-colors inline-flex items-center gap-2" to="/new-arrivals">
